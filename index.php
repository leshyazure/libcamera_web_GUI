...
<head>
    ...
    <meta name="description" content="Libcamera web controller">
    <meta name="author" content="DP">
    <link href="css/bootstrap.css" rel="stylesheet" type="text/css">
    <link rel="icon" href="../../../../favicon.ico">
    <title>PHP camera controller</title>
...
<body>
<div class="container-fluid p-4 text-left" style="width: 98%;">
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-sm-7 float-left" onclick="executeCommand('ctrl', 'snap')">
                <img src="default.png" width="1024" height="576" id="preview"/>
            </div>
            ...
            <div class="col-sm-5 float-right">
                <div class="col-sm-12">
                    ...
                    <div class="text-center my-2 pb-3">
                        <h3>PHP camera controller</h3>
                    </div>
                </div>
                <form>
                    <div class="my-2 form-group row form-inline">
                        <label for="pattern" class="col-sm-2 col-form-label">Filename</label>
                        <div class="col-sm-5">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="col-sm-2 form-control" id="counter" value="0">
                        </div>
                        <div class="col-sm-2">
                            <button type="button" class="col-sm-1 btn btn-success form-control" id="reset"
                    ...
                    <div class="my-2 form-group row">
                        <label for="shutter" class="col-sm-2 col-form-label">Shutter (μs)</label>
                        <div class="col-sm-10">
                            <input type="number" class="col-sm-2 form-control" id="shutter" value="0">
                        </div>
                    </div>
                    <div class="my-2 form-group row">
                        <label for="gain" class="col-sm-2 col-form-label">Gain</label>
                        <div class="col-sm-10">
                            <input type="number" class="col-sm-2 form-control" id="gain" value="0">
                        </div>
                    </div>
                    <div class="my-2 form-group row">
                        <label for="exposure" class="col-sm-2 col-form-label">Exposure</label>
                        <div class="col-sm-10">
                            <input type="number" class="col-sm-2 form-control" id="exposure" value="0">
                        </div>
                    </div>
                    <div class="my-2 form-group row">
                        <label for="awb" class="col-sm-2 col-form-label">AWB mode</label>
                        <div class="col-sm-10">
                    ...
                    <div class="my-2 form-group row">
                        <label for="awb_gain" class="col-sm-2 col-form-label">AWB gain</label>
                        <div class="col-sm-1 checkbox-inline">
                            <label for="awb_r" class="col-sm-2 col-form-label">Red:</label>
                        </div>
                        <div class="col-sm-3 checkbox-inline">
                            <input type="number" class="col-sm-2 form-control" id="awb_r" value="0">
                        </div>
                        <div class="col-sm-1 checkbox-inline">
                            <label for="awb_b" class="col-sm-2 col-form-label">Blue:</label>
                        </div>
                        <div class="col-sm-3 checkbox-inline">
                            <input type="number" class="col-sm-2 form-control" id="awb_b" value="0">
                        </div>
                    </div>
                    <div class="my-2 form-group row">
                        <label for="brightness" class="col-sm-2 col-form-label">Brightness</label>
                        <div class="col-sm-10">
                            <input type="number" class="col-sm-2 form-control" id="brightness" value="0.0">
                        </div>
                    </div>
                    <div class="my-2 form-group row">
                        <label for="contrast" class="col-sm-2 col-form-label">Contrast</label>
                        <div class="col-sm-10">
                            <input type="number" class="col-sm-2 form-control" id="contrast" value="1.0">
                        </div>
                    </div>

                    <div class="my-2 form-group row">
                        <label for="tuning-file" class="col-sm-2 col-form-label">Tuning file</label>
                        <div class="col-sm-10">
                    ...
                    <div class="my-2 form-group row">
                        ...
                        <label for="raw" class="col-sm-2 col-form-label">Save as RAW</label>
